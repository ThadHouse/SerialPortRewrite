...
class SerialIO : public IIOProvider {
    ...
    frc2::SerialPort::Port serial_port_id;
    frc2::SerialPort *serial_port;
...
public:
    SerialIO( frc2::SerialPort::Port port_id,
              uint8_t update_rate_hz,
              bool processed_data,
              IIOCompleteNotification *notify_sink,
              IBoardCapabilities *board_capabilities );
...
private:
    ...
    frc2::SerialPort *ResetSerialPort();
    frc2::SerialPort *GetMaybeCreateSerialPort();
