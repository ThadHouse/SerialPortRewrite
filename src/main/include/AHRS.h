...
public:
    ...
    AHRS(frc2::SerialPort::Port serial_port_id);
    ...
    AHRS(frc2::SerialPort::Port serial_port_id, AHRS::SerialDataType data_type, uint8_t update_rate_hz);
...
private:
    ...
    void SerialInit(frc2::SerialPort::Port serial_port_id, AHRS::SerialDataType data_type, uint8_t update_rate_hz);
